...
<form action="index.php?p=fungsi" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" name="nim" class="form-control w-50" id="exampleInputPassword1" placeholder="Masukkan NIM . . ." required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Program Studi</label>
    <select name="prodi" class="form-control w-50" value= "" required>
       <option value="_" selected="selected">- Pilih Prodi -</option>
